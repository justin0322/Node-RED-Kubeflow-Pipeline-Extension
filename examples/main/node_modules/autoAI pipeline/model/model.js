    ...
    function ModelCreator(config) {
        ...
        node.on('input', function(msg) {
            if (msg.algorithm === "randomforest"){
                script = util.format(snippets.UPLOAD_RANDOMFOREST, epochs, model_name);
            }else if (msg.algorithm === "decisiontree"){
                script = util.format(snippets.UPLOAD_DECISIONTREE, epochs, model_name);
            }else{
                script = util.format(snippets.UPLOAD_LOGISTICREGRESSION, epochs, model_name);
            }
            msg.payload += script;
