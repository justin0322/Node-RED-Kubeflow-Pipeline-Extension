<script type="text/javascript">
    RED.nodes.registerType('datasets', {
        ...
        defaults: {
            name: { value: "" },
            customized_datasets: { value: "none", required: true },
            traditional_datasets: { value: "none", required: true },
        ...
        oneditprepare: function() {
            ...
            $(".datasets-toggle button").on("click", function() {
                nodeInputSource.val($(this).hasClass("datasets-traditional") ? "traditional" : "customized");
