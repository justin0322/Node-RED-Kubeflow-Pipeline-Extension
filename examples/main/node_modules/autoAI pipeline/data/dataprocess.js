...
module.exports = function(RED) {
    ...
    function assembleScript(config, msg) {
        ...
        const datareshape = data_reshape === "1D"
            ...
            : util.format(snippets.DATA_RESHAPE2D, height, width, channel);

            return {
                script: util.format(snippets.DATAPROCESS, fill_na, labelencoding, onehotencoding, config.train_test_split, datareshape, featurescaling),
                fill_na,
                labelencoding,
                onehotencoding,
                featurescaling,
